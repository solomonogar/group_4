      ...
      <div className="home-area">
        <div className="first-container">
          <div className="welcome__contianer">
            <span>
              {" "}
              <h1 className="welcome">Wendy Ju</h1>
            </span>
          </div>
        ...
        <div className="client-contianer">
          <div className="client-main">
            <p className="client">
              <b>Client: inQ Services</b>
            </p>
            <div className="increase">
              Increasing operational efficiency in facilities management
            </div>
            <div className="product">
              0-to-1 Product Design | SaaS Platform <br />| Web Design |
              AppDesign |<br /> Stakeholder Management
            </div>
          </div>
        ...
        <div className="empower-contianer">
          ...
          <div className="empower-main">
            <div className="empower">
              Empowering female solo
              <br /> travelers with <br />
              trustworthy and <br />
              relevant safety
              <br /> information
            </div>
            <div className="product">
              {" "}
              Web Design | Material Design | UX <br /> Design
            </div>
          </div>
        </div>
        <div className="enhance-contianer">
          <div className="enhance-main">
            <p className="client">
              <b>Client: Guardian Life</b>
            </p>

            <div className="increase">
              Enhancing financial planning experience through rebranding
            </div>
            <div className="product">
              {" "}
              Visual Design | Responsive Design | <br /> Rebranding
            </div>
          </div>
          <img
            className="thirdpic"
        ...
        <div className="increase-contianer">
          ...
          <div className="increase-main">
            <div className="increasing">
              ...
              <br /> in young adults to form
              <br /> long term
              <br /> habits through
              <br /> gamification
            </div>
            <div className="product">
              Physical Product | App Design | <br />
